...
process.source = cms.Source("PoolSource",
                            fileNames=cms.untracked.vstring(
                                ...
                                'file:/uscms_data/d3/yfeng/SONICTutorial/CMSSW_12_0_0_pre4/src/RecoMET/METPUSubtraction/test/A256C80D-0943-E811-998E-7CD30AB0522C.root',
                            ),
                            )
...
## uncomment this part if there is one server running at 0.0.0.0 with grpc port 8021
...
for msg in ['TritonClient', 'TritonService', 'DeepMETSonicProducer', 'DeepMETSonicProducer:TritonClient']:
