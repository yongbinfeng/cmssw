...
samples = [
    ...
    (0, '/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-fixECALGT_LowPU_94X_mc2017_realistic_v10For2017H_v2_ext1-v1/MINIAODSIM', 5), # 82 files 
    ...
    (0, '/TTToHadronic_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-fixECALGT_LowPU_94X_mc2017_realistic_v10For2017H_v2_ext1-v1/MINIAODSIM', 10), # 169
    (0, '/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/RunIIFall17MiniAODv2-fixECALGT_LowPU_94X_mc2017_realistic_v10For2017H_v2_ext1-v1/MINIAODSIM', 20), # 266
    (0, '/WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8/RunIIFall17MiniAODv2-fixECALGT_LowPU_94X_mc2017_realistic_v10For2017H_v2_ext1-v1/MINIAODSIM', 20), # 20
    ...
    (1, '/HighEGJet/Run2017H-17Nov2017-v1/MINIAOD', 20), # 1070 files in total
    (1, '/SingleMuon/Run2017H-17Nov2017-v2/MINIAOD', 20), # 428 files in total
]
...
for isData, path, nfiles_per_job in samples:
    ...
    file_entries.append('config.General.requestName = "production_LowPUNano_%s"' %(base_name))
